...
describe('Login Component', () => {
  ...
  it('should have correct initial state', inject([LoginSmallComponent],
    (login:LoginSmallComponent) => {
  ...
  it('should change state and redirect when login success', inject([LoginSmallComponent, AuthService, Router],
    (login:LoginSmallComponent, auth:AuthServiceStub, router:RouterStub) => {
