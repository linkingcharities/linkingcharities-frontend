...
var projects_page_component_1 = require("./components/projects-page/projects-page.component");
var routes = [
    ...
    { path: 'projects', component: projects_page_component_1.ProjectsPageComponent }
];
